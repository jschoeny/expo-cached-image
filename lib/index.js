...
exports.CacheManager = {
    ...
    keyExists: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var metadata;
        var key = _b.key;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, FileSystem.getInfoAsync("".concat(CONST.IMAGE_CACHE_FOLDER).concat(key, ".png"))];
                case 1:
                    metadata = _c.sent();
                    return [2 /*return*/, metadata.exists];
            }
        });
    }); },
